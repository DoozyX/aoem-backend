...
import { <%= name %>Entity } from '../../../../<%= h.inflection.transform(name, ['pluralize', 'underscore', 'dasherize']) %>/persistence/entities/<%= h.inflection.transform(name, ['underscore', 'dasherize']) %>.entity';
